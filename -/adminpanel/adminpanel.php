...
<body>
    <form action="./vender/sendform.php" method="post">
        <label>Предмет</label>
        <input type="text" name="object" placeholder="Предмет">
    ...
    <form action="./vender/sendform.php" method="post">
        ...
        <input type="text" name="them" id="them" placeholder="Тема лекции">
        <button type="submit">Отправить</button>
    </form>
    <form action="./vender/sendform.php" method="POST" enctype="multipart/form-data">
        <label for="name">Название</label>
        <input type="text" name="name" id="name" placeholder="Название лекции">
        <label for="them_id">Тема</label>
        <select name="them_id" id="them_id">
